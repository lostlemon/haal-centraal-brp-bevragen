...
Functionaliteit: Aanpasbare representatie met de fields parameter
  ...
  Scenario: Relaties (links) vragen (en beperken) in het antwoord1
  ...
  Scenario: Relaties (links) vragen (en beperken) in het antwoord2
    Gegeven de te raadplegen persoon heeft een actuele partner(partnerschap of huwelijk), ouders en kinderen
    En de te raadplegen persoon heeft een BAG-adres (nummeraanduiding) als verblijfplaats
  ...
  Scenario: Relaties (links) vragen (en beperken) in het antwoord3
    Gegeven de te raadplegen persoon heeft een actuele partner(partnerschap of huwelijk), ouders en kinderen
    En de te raadplegen persoon heeft een BAG-adres (nummeraanduiding) als verblijfplaats
  ...
  Scenario: Relaties (links) vragen (en beperken) in het antwoord4
    Gegeven de te raadplegen persoon heeft een actuele partner(partnerschap of huwelijk), ouders en kinderen
    En de te raadplegen persoon heeft een BAG-adres (nummeraanduiding) als verblijfplaats
  ...
  Scenario: Gebruik van de fields parameter heeft geen invloed op embedded sub-resources1
  ...
  Scenario: Gebruik van de fields parameter heeft geen invloed op embedded sub-resources2
...
#    En wordt in _links geen enkel ander attribuut dan self teruggegeven
  ...
  Scenario: inOnderzoek wordt altijd teruggegeven wanneer dat van toepassing is1
    Gegeven de te raadplegen persoon heeft geboortedatum in onderzoek (83.10 = 010310)
    Als bsn 999992843 wordt geraadpleegd met fields=geboorte.datum
    Dan wordt attribuut geboorte.datum teruggegeven
  ...
  Scenario: inOnderzoek wordt altijd teruggegeven wanneer dat van toepassing is2
    Gegeven de te raadplegen persoon heeft naam in onderzoek (83.10 = 010200)
    Als bsn 999992466 wordt geraadpleegd met fields=naam
    Dan is in het antwoord naam.inOnderzoek.voornamen=true
#   En is in het antwoord naam.inOnderzoek.adellijkeTitel_predikaat=true  // niet in swagger contract
    Dan is in het antwoord naam.inOnderzoek.voorvoegsel=true
    Dan is in het antwoord naam.inOnderzoek.geslachtsnaam=true
#   En is in het antwoord attribuut naam.inOnderzoek.aanduidingNaamgebruik afwezig // niet in swagger contract
    En is in het antwoord attribuut inOnderzoek afwezig

  Scenario: inOnderzoek wordt altijd teruggegeven wanneer dat van toepassing is3
    Gegeven de te raadplegen persoon heeft naam in onderzoek (83.10 = 010200)
#   Als een ingeschreven persoon wordt geraadpleegd met fields=naam.voornamen,naam.geslachtsnaam
    Als bsn 999992466 wordt geraadpleegd met fields=naam.voornamen,naam.geslachtsnaam
    Dan is in het antwoord naam.inOnderzoek.voornamen=true
#   En is in het antwoord attribuut naam.inOnderzoek.adellijkeTitel_predikaat afwezig // niet in swagger contract
#   foute spec, moet wel aanwezig zijn:
    En is in het antwoord naam.inOnderzoek.voorvoegsel=true 
    En is in het antwoord naam.inOnderzoek.geslachtsnaam=true
#   En is in het antwoord attribuut naam.inOnderzoek.aanduidingNaamgebruik afwezig // niet in swagger contract
    En is in het antwoord attribuut inOnderzoek afwezig

  Scenario: inOnderzoek wordt altijd teruggegeven wanneer dat van toepassing is4
    Gegeven de te raadplegen persoon heeft naam in onderzoek (83.10 = 010200)
#   Als een ingeschreven persoon wordt geraadpleegd met fields=geboorte
    Als bsn 999992466 wordt geraadpleegd met fields=geboorte
    Dan is in het antwoord attribuut naam.inOnderzoek afwezig
    En is in het antwoord attribuut geboorte.inOnderzoek afwezig
    En is in het antwoord attribuut inOnderzoek afwezig

  Scenario: inOnderzoek wordt altijd teruggegeven wanneer dat van toepassing is5
    Gegeven de te raadplegen persoon heeft de hele categorie persoon in onderzoek (83.10 = 010000)
#   Als een ingeschreven persoon wordt geraadpleegd met fields=geboorte
    Als bsn 999994888 wordt geraadpleegd met fields=geboorte
