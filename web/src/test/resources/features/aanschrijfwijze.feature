...
Functionaliteit: Als gemeente wil ik de juiste en consistente aanschrijfwijze van mijn burgers
  ...
  Abstract Scenario: De aanschrijfwijze wordt samengesteld op basis van aanduidingAanschrijving en naamgegevens van de persoon en de partner
    Gegeven een ingeschreven persoon met <voornamen>, <geslachtsnaam>, <aanduidingAanschrijving>
    Als ingeschreven persoon wordt geraadpleegd met <voornamen>, <geslachtsnaam>, <aanduidingAanschrijving>
    ...
    Voorbeelden: partner heeft een adellijke titel
      ...
      | M | V | Gravin | E | VL VV GN          | Veen  | Johannus       | J. van der Veen |
      | M | V | Gravin | N | VL VV GN-AP VP GP | Veen  | Johannus       | J. van der Veen-graaf van den Aedel |
      | M | V | Gravin | P | VL AP VP GP       | Veen  | Johannus       | J. graaf van den Aedel |
      | M | V | Gravin | V | VL AP VP GP-VV GN | Veen  | Johannus       | J. graaf van den Aedel-van der Veen |
