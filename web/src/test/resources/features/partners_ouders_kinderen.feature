...
Functionaliteit: De resource ingeschrevenpersonen bevat alleen relaties naar actuele partners, ouders en kinderen
  ...
  Scenario: Huwelijk/partnerschap is ontbonden
    ...
    Als de ingeschreven persoon met burgerservicenummer 555555938 wordt geraadpleegd
    Dan is _links.partners leeg
    Als ingeschreven persoon met burgerservicenummer 555555938 wordt geraadpleegd met expand=partners
    Dan is _links.partners leeg
    En is _embedded.partners leeg
    Als de partners worden geraadpleegd van de ingeschreven persoon met burgerservicenummer 555555938
