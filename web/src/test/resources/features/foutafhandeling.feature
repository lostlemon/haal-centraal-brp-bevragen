...
#   En is in het antwoord invalid-params.reason=<reason>
    ...
    Voorbeelden:
      ...
      | expand       | Deel van de parameterwaarde is niet correct: true.        | ingeschrevenpersonen | expand              | true                        |
...
#   En is in het antwoord invalid-params.reason=<reason>
    ...
    Voorbeelden:
      ...
      | format       | Waarde is geen geldige datum.                                | ingeschrevenpersonen | geboorte__datum                         | 23-04-2019                  |
      | format       | Waarde is geen geldige datum.                                | ingeschrevenpersonen | geboorte__datum                         | 1983-05-00                  |
