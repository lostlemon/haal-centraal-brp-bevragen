...
Functionaliteit: Hyperlinks naar gerelateerde resources worden opgenomen in _links
  ...
  Scenario: self link van een collectie
    ...
    Dan bevat attribuut _links.self.href /ingeschrevenpersonen
  ...
  Scenario: self link van een resource in een collectie
    ...
    Dan geldt voor elk van de gevonden ingeschrevenpersonen dat attribuut _links.self.href de tekst /ingeschrevenpersonen bevat
  ...
  Scenario: self link van een resource
    Als ingeschreven persoon met burgerservicenummer 999993677 wordt geraadpleegd zonder fields-parameter en zonder expand-parameter
    Dan eindigt attribuut _links.self.href met /ingeschrevenpersonen/999993677
    En begint attribuut _links.self.href met http:// of https://
  ...
  Scenario: self link van een resource-aanroep met expand en fields
    ...
    Dan bevat attribuut _links.self.href /ingeschrevenpersonen/999999023
    Dan bevat attribuut _links.self.href fields=overlijden,geboorte,naam
    Dan bevat attribuut _links.self.href expand=partners,kinderen
    En begint attribuut _links.self.href met http:// of https://

  Scenario: self link van een embedded resource
    Als ingeschreven persoon met burgerservicenummer 999993677 wordt geraadpleegd met expand=partners
    Dan bevat het attribuut _links.self.href in elke van de gevonden _embedded.partners /ingeschrevenpersonen/999993677/partners
  ...
  Scenario: link naar een gerelateerde resource binnen dezelfde API
    ...
    Dan bevat het attribuut href in elke van de gevonden _links.partners /ingeschrevenpersonen/999999023/partners
