...
Functionaliteit: Kinderen van een ingeschreven persoon raadplegen
  ...
  Scenario: kind ophalen vanuit links van ingeschreven persoon via sub-resource kinderen
    Gegeven de te raadplegen persoon heeft een kind dat zelf ingeschreven persoon is
    En het kind van de ingeschreven persoon heeft in de registratie burgerservicenummer 999990032, naam Franklin	Groenen, geboren op 26 mei 1983
    Als de ingeschreven persoon met burgerservicenummer 999993677 wordt geraadpleegd
    En de link kinderen wordt gevolgd
    Dan is in het antwoord burgerservicenummer=999990032
    En is in het antwoord naam.voornamen=Mihailović
    En is in het antwoord naam.voorvoegsel=null
    En is in het antwoord naam.geslachtsnaam=Bilgiç
    En is in het antwoord naam.adellijkeTitel_predikaat.omschrijvingAdellijkeTitel_predikaat=null
    En is in het antwoord geboorte.datum.datum=1992-10-09
